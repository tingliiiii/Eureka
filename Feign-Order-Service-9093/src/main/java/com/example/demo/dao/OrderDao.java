...
public class OrderDao {
	...
	static {
		...
		Order order1 = new Order(1, 2, "2024-06-07", new ArrayList<>(List.of(
		...
		// 訂單編號, 客戶編號, 訂單日期, 訂單明細(項目), 總計
		Order order2 = new Order(2, 1, "2024-06-02", new ArrayList<>(List.of(
				// 訂單明細(項目)編號, 訂單主檔編號, 產品編號, 訂購數量, 小計
				new Item(1, 2, 2, 4, 0),
				new Item(2, 2, 3, 1, 0)
		)), 0);
		...
		// 訂單編號, 客戶編號, 訂單日期, 訂單明細(項目), 總計
		Order order3 = new Order(3, 3, "2024-06-03", new ArrayList<>(List.of(
				// 訂單明細(項目)編號, 訂單主檔編號, 產品編號, 訂購數量, 小計
				new Item(1, 3, 1, 2, 0),
				new Item(2, 3, 2, 4, 0),
				new Item(3, 3, 3, 1, 0)
		...
		// 訂單編號, 客戶編號, 訂單日期, 訂單明細(項目), 總計
		Order order4 = new Order(4, 3, "2024-06-04", new ArrayList<>(List.of(
				// 訂單明細(項目)編號, 訂單主檔編號, 產品編號, 訂購數量, 小計
				new Item(1, 4, 1, 7, 0)
		)), 0);
