...
public class CustomerDao {
	...
	static {
		customers.add(new Customer(1, "Irin", "irin@gmail.com"));
		customers.add(new Customer(2, "Katy", "katy@yahoo.com"));
		customers.add(new Customer(3, "Nikolas", "nikolas@hotmail.com"));
	}
